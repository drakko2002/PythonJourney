...
class ChatInterface:
    ...
    def conectar(self):
        if not self.conectado:
            while True:  # Tentativas de reconexão
                try:
                    # Criação do socket e tentativa de conexão
                    ...
                    break  # Sai do loop após conexão bem-sucedida

                except ConnectionRefusedError:
                    # Em caso de erro, tenta reconectar após 5 segundos
