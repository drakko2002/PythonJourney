...
#Aqui declaramos uma lista de números que contém os algarismos aleatórios dentro
#de 1 até 100, com um tamanho estabelecido em 20.
'''É importante estabelecer o tamanho da lista para evitar anomalias.'''
